...
3. Create user privelges (i.e. edit, delete posts, comment, review article and user related posts).
...
The shown routes in wireframes includes index and Show routes. Additional routes not shown includes, new, edit anmd our story routes
...
### Nsikak Udoh
Focused on Front-End Development, some Backend Development
